...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Dr. Abhinav Jogani — Orthopedic & Joint Replacement Surgeon, Nagpur" },
      { property: "og:description", content: "Restoring Movement. Rebuilding Lives. Book a consultation with Nagpur's leading orthopedic surgeon." },
